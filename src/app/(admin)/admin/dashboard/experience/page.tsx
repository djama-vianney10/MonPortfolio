  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => { setEditingExp(null); setIsModalOpen(true) }}>
      ...
      {loading ? (
        ...
        <div className="bg-gray-900 rounded-xl border border-gray-800 p-12 text-center">
          ...
          <Button onClick={() => setIsModalOpen(true)}>Add your first experience</Button>
        </div>
      ) : (
        <div className="space-y-4">
          {experiences.map((exp) => (
      ...
      {isModalOpen && (
        <ExperienceFormModal experience={editingExp} onClose={handleModalClose} />
      )}
    </div>
  )
}