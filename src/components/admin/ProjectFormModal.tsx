// 2. REFAIRE COMPLÈTEMENT: src/components/admin/ProjectFormModal.tsx
    ...
    try {
      ...
      if (imageFile) {
        ...
        if (!uploadRes.ok) {
          ...
          throw new Error(error.error || "Échec du téléchargement de l'image")
        }
      ...
      if (res.ok) {
        ...
        throw new Error(error.error || 'Échec de la sauvegarde du projet')
      }
    } catch (error) {
        ...
        <div className="bg-gray-900 rounded-xl border border-gray-800 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div className="flex gap-3 pt-4">
              <Button type="submit" isLoading={loading} className="flex-1" disabled={loading}>
